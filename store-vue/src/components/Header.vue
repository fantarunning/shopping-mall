...
import {HomeFilled,ChatDotRound,Flag} from "@element-plus/icons-vue";
// 图片地址
...
<template>
  ...
  >
    ...
    <el-menu-item index="1">
      <el-image style="width: 60px; height: 60px;border-radius: 50%;" :src="url"  />~ |香薰商城后台管理系统
    </el-menu-item>
    </div>
    <div class="menu-right">
    <el-menu-item index="/manage/index"><el-icon><HomeFilled /></el-icon>首页
    </el-menu-item>
    <el-menu-item index="/manage/userAll">
      <span>用户管理</span>
    </el-menu-item>
    ...
    <el-menu-item index="/manage/popular">
      <span>科普资源</span>
    </el-menu-item>
    <el-menu-item index="/TeachingCenter">
      <span><el-icon><ChatDotRound /></el-icon>问答社区</span>
    </el-menu-item>
    <el-sub-menu index="10">
      ...
      <el-menu-item index="/manage/password">修改密码</el-menu-item>
      <el-menu-item index="/manage/password">发布公告</el-menu-item>
