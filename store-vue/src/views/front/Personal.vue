...
const handleAvatarSuccess = (res) => {
  console.log(res)
  user.value.avatar = res.msg
}
</script>

<template>
  <el-form :model="user" :rules="rules" ref="userForm" label-width="auto" style="width: 400px;">
    <el-form-item label="账号" prop="username">
      <el-input v-model="user.username" autocomplete="off" readonly/>
    </el-form-item>
...
<!--        <el-option label="用户" value="USER"/>-->
    ...
    <!--      <el-form-item label="状态" prop="remark">
            <el-radio-group v-model="user.remark">
    ...
    <el-form-item label="头像">
      ...
      >
        <img v-if="user.avatar" :src="user.avatar" class="avatar" style="width: 300px"/>
